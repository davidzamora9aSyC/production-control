...
export default function SesionIndicadoresModal({ sesionId, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-[95vw] h-[90vh] max-w-6xl p-4 flex flex-col">
          ...
          <div className="border rounded-lg p-3 overflow-y-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
              {METRIC_DEFS.map((m) => {
                ...
                return (
                  <label key={m.key} className={`flex items-center gap-2 text-sm ${disabled ? "opacity-50" : ""}`}>
