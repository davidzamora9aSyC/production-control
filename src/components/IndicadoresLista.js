...
const ALL_METRICS = [
  ...
  { key: "avgSpeed", label: "Velocidad productiva (sin tiempos muertos)" },
  { key: "avgSpeedSesion", label: "Velocidad global (con tiempos muertos)" },
  { key: "nptMin", label: "Tiempos muertos en minutos" },
  { key: "nptPorInactividad", label: "Tiempos muertos por inactividad" },
  { key: "porcentajeNPT", label: "% Tiempos muertos" },
  { key: "pausasMin", label: "Tiempo en pausas en minutos" },
  { key: "pausasCount", label: "# Pausas" },
  { key: "porcentajePausa", label: "% Tiempo en pausas" },
  { key: "duracionTotalMin", label: "Duración total en minutos" },
